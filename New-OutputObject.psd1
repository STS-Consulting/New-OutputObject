...
@{
    ...
    ModuleVersion     = '2026.09.16.1345'

    # Supported PSEditions
    # CompatiblePSEditions = @('Desktop','Core')

    # ID used to uniquely identify this module
    GUID              = 'c69afd2d-6e61-42e9-a287-a0a12ea265a1'
    ...
    Copyright         = 'Copyright (c) 2016-2018 Wojciech Sciesinski. This module is licensed under The MIT License (MIT)  '

    # Description of the functionality provided by this module
    Description       = 'The PowerShell module intended for preparing PowerShell objects what the next help output filesystem objects, means: files and folders.'
    ...
    FunctionsToExport = @('New-OutputObject', 'New-OutputFile', 'New-OutputFolder')
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            Tags         = @('FileSystem', 'Folder', 'File', 'PSEdition_Core', 'PSEdition_Desktop')

            # A URL to the license for this module.
            LicenseUri   = 'https://github.com/it-praktyk/New-OutputObject/blob/master/LICENSE'

            # A URL to the main website for this project.
            ProjectUri   = 'https://github.com/it-praktyk/New-OutputObject'

            # A URL to an icon representing this module.
            # IconUri = ''

            # ReleaseNotes of this module
            ReleaseNotes = 'https://github.com/it-praktyk/New-OutputObject/blob/master/CHANGELOG.md'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBRzbdZPVFjrqt7
# 1XQZve7nf563sFE+HULRjtDKWvTt6KCCFnYwggM4MIICIKADAgECAhBq68etXxgs
...
# KwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgU3crww4a3Z0QtRnGeei9HaBXuFF0
# 98wZSHjqcp403mowDQYJKoZIhvcNAQEBBQAEggEAq5kRh63LmK/Arq6Ho7ydYmMJ
# 3c47gQ/6kFaR42hBlp5vPnv/YtIT+G9bGtNqXouCU4bTDfhAWK2WpFXIzJ5r/mZM
# J/a+hg/fEwngutBb3YMexDuJfCsdEZ6WAZWK5Hp4a0IdbtRNCxQN2kGzD09ZthC3
# 8ivcfB8BugX3U5BkT1XSJhq0nhuwgvm7qKe6VHo/avyikBkAhX6a/Rts5mlZ/tUj
# 7lNXN7N5Z9n98jihyVucvUTCDNX4BoPAMlG56+vDEBscOz6jhc9nUis0Jl3Lr7LE
# SG60y44NxqmsYyDSt7UYrQ7VaeEe0b6OuRn5uAxYMiy9Zo1hL1v/G7FVV7vN+qGC
...
# hvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNjA5MTYyMDU2MTBaMC8GCSqGSIb3DQEJ
# BDEiBCDzNH0rjnxbNGuwIQD5OFV39q4iTQMQS6rv7DETjuCdKzANBgkqhkiG9w0B
# AQEFAASCAgCpMzgi8duEVpOwp0EW51CPWR1cyAd2ZEtzZO0QsEco99gYYcApixe8
# iIs7OkPDLCXNp2NgjD6RLtRSH6x8qzaNZv1IZ9F696rwgQizWDtFc+jUt8BObfik
# aPdD/GV/nVZWpLeB+4iZf/57OPm6zfJg0m7aj48WkOxbbgCeA91w79Ezj5saA2Ls
# p6CCCRhfusmnq9KrlsQnIuAaYqnxHQ1zv8fCmm8IbpX4xx0/7JXysD5GR4myzSSY
# m4ew+8vEDTIkw/uKW1+vY66D4mddoQ2l2f81LRVOgr24pCOzTo8X41e2IYyeq5VF
# VmaCZe1QlYdBMlP4WJhZ5DHtzerFFRumGWMvvMTWAW4XvHpfLBAuyP0YxgUU5vbj
# cSREyJdMXzTabmL9Qq1cgJ2GII2pcxLbnN7U7nTFyF88FHn1T1G/NJ8b4zSVLYlC
# 6jUKqpkeh+A/bz8lMD5VTRmhh+DlGSfPZUhpZhKMBpmJrtR7BvO2HbvvuiQxmlKA
# gJoycrOHfxLMGW5t7p9PIXO6IgZ+k2huYzKAts0JZBNytr8bpfEGTwELjuOxJLea
# NGpcCDu8uFivwFeeFnQ/CEhKZMs/NAudWNtD8yj9hw0z7sYEcx4XGgSgMG2wF5T2
# AzvpUdhz7gtnSus7cEFmZ/UczSZBLSCZhBw+d8vLnqWTYtwPxDK85w==
